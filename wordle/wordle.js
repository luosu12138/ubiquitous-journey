...
let wordList = ["aback", "abase", "abate", "abbey", "abbot", "abhor", "abide", "abled", "abode", "abort", "about", "above", "abuse", "abyss", "acorn", "acrid", "actor", "acute", "adage", "adapt", "adept", "admin", "admit", "adobe", "adopt", "adore", "adorn", "adult", "affix", "afire", "afoot", "afoul", "after", "again", "agape", "agate", "agent", "agile", "aging", "aglow", "agony", "agree", "ahead", "aider", "aisle", "alarm", "album", "alert", "algae", "alibi", "alien", "align", "alike", "alive", "allay", "alley", "allot", "allow", "alloy", "aloft", "alone", "along", "aloof", "aloud", "alpha", "altar", "alter", "amass", "amaze", "amber", "amble", "amend", "amiss", "amity", "among", "ample", "amply", "amuse", "angel", "anger", "angle", "angry", "angst", "anime", "ankle", "annex", "annoy", "annul", "anode", "antic", "anvil", "aorta", "apart", "aphid", "aping", "apnea", "apple", "apply", "apron", "aptly", "arbor", "ardor", "arena", "argue", "arise", "armor", "aroma", "arose", "array", "arrow", "arson", "artsy", "ascot", "ashen", "aside", "askew", "assay", "asset", "atoll", "atone", "attic", "audio", "audit", "augur", "aunty", "avail", "avert", "avian", "avoid", "await", "awake", "award", "aware", "awash", "awful", "awoke", "axial", "axiom", "axion", "azure", "bacon", "badge", "badly", "bagel", "baggy", "baker", "baler", "balmy", "banal", "banjo", "barge", "baron", "basal", "basic", "basil", "basin", "basis", "baste", "batch", "bathe", "baton", "batty", "bawdy", "bayou", "beach", "beady", "beard", "beast", "beech", "beefy", "befit", "began", "begat", "beget", "begin", "begun", "being", "belch", "belie", "belle", "belly", "below", "bench", "beret", "berry", "berth", "beset", "betel", "bevel", "bezel", "bible", "bicep", "biddy", "bigot", "bilge", "billy", "binge", "bingo", "biome", "birch", "birth", "bison", "bitty", "black", "blade", "blame", "bland", "blank", "blare", "blast", "blaze", "bleak", "bleat", "bleed", "bleep", "blend", "bless", "blimp", "blind", "blink", "bliss", "blitz", "bloat", "block", "bloke", "blond", "blood", "bloom", "blown", "bluer", "bluff", "blunt", "blurb", "blurt", "blush", "board", "boast", "bobby", "boney", "bongo", "bonus", "booby", "boost", "booth", "booty", "booze", "boozy", "borax", "borne", "bosom", "bossy", "botch", "bough", "boule", "bound", "bowel", "boxer", "brace", "braid", "brain", "brake", "brand", "brash", "brass", "brave", "bravo", "brawl", "brawn", "bread", "break", "breed", "briar", "bribe", "brick", "bride", "brief", "brine", "bring", "brink", "briny", "brisk", "broad", "broil", "broke", "brood", "brook", "broom", "broth", "brown", "brunt", "brush",
    "brute", "buddy", "budge", "buggy", "bugle", "build", "built", "bulge", "bully", "bunch", "bunny", "burly", "burnt", "burst", "bused", "bushy", "butch", "butte", "buxom", "buyer", "bylaw", "cabal", "cabby", "cabin", "cable", "cacao", "cache", "cacti", "caddy", "cadet", "cagey", "cairn", "camel", "cameo", "canal", "candy", "canny", "canoe", "canon", "caper", "caput", "carat", "cargo", "carol", "carry", "carve", "caste", "catch", "cater", "catty", "caulk", "cause", "cavil", "cease", "cedar", "cello", "chafe", "chaff", "chain", "chair", "chalk", "champ", "chant", "chaos", "chard", "charm", "chart", "chase", "chasm", "cheap", "cheat", "check", "cheek", "cheer", "chess", "chest", "chick", "chide", "chief", "child", "chili", "chill", "chime", "china", "chirp", "chock", "choir", "choke", "chord", "chore", "chose", "chuck", "chump", "chunk", "churn", "chute", "cider", "cigar", "cinch", "circa", "civic", "civil", "clack", "claim", "clamp", "clang", "clank", "clash", "clasp", "class", "clean", "clear", "cleat", "cleft", "clerk", "click", "cliff", "climb", "cling", "clink", "cloak", "clock", "clone", "close", "cloth", "cloud", "clout", "clove", "clown", "cluck", "clued", "clump", "clung", "coach", "coast", "cobra", "cocoa", "colon", "color", "comet", "comfy", "comic", "comma", "conch", "condo", "conic", "copse", "coral", "corer", "corny", "couch", "cough", "could", "count", "coupe", "court", "coven", "cover", "covet", "covey", "cower", "coyly", "crack", "craft", "cramp", "crane", "crank", "crash", "crass", "crate", "crave", "crawl", "craze", "crazy", "creak", "cream", "credo", "creed", "creek", "creep", "creme", "crepe", "crept", "cress", "crest", "crick", "cried", "crier", "crime", "crimp", "crisp", "croak", "crock", "crone", "crony", "crook", "cross", "croup", "crowd", "crown", "crude", "cruel", "crumb", "crump", "crush", "crust", "crypt", "cubic", "cumin", "curio", "curly", "curry", "curse", "curve", "curvy", "cutie", "cyber", "cycle", "cynic", "daddy", "daily", "dairy", "daisy", "dally", "dance", "dandy", "datum", "daunt", "dealt", "death", "debar", "debit", "debug", "debut", "decal", "decay", "decor", "decoy", "decry", "defer", "deign", "deity", "delay", "delta", "delve", "demon", "demur", "denim", "dense", "depot", "depth", "derby", "deter", "detox", "deuce", "devil", "diary", "dicey", "digit", "dilly", "dimly", "diner", "dingo", "dingy", "diode", "dirge", "dirty", "disco", "ditch", "ditto", "ditty", "diver", "dizzy", "dodge", "dodgy", "dogma", "doing", "dolly", "donor", "donut", "dopey", "doubt", "dough", "dowdy", "dowel", "downy", "dowry", "dozen", "draft", "drain", "drake", "drama", "drank", "drape", "drawl", "drawn", "dread", "dream", "dress", "dried", "drier", "drift", "drill", "drink", "drive", "droit", "droll", "drone", "drool", "droop",
...
function render(e) {
    ...
    if ("KeyA" <= e.code && e.code <= "KeyZ") {
        if (col < answerLength) {
            let letter = document.getElementById(row.toString() + "-" + col.toString());
            if (letter.innerText == "") {
                letter.innerText = e.code[3];
                col++;
                guess = guess + e.code[3];
            }
        }
    }
    else if (e.code === "Backspace") {
        if (0 < col && col <= answerLength) {
            col -= 1;
    ...
    if (state === "SOLVED") {
        document.getElementById("result").innerText = "猜测正确！";
        document.getElementById("button").style.visibility = 'visible';
    }
    if (state === "UNFINISHED" && row === maxGuessTime) {
        state = "FAILED";
        document.getElementById("result").innerText = `答案为:${answer.toUpperCase()}`;
        document.getElementById("button").style.visibility = 'visible';
    }
...
function initialize() {
    ...
    for (let i = 0; i < keyboard.length; i++) {
        ...
        for (let j = 0; j < currRow.length; j++) {
            ...
            if (key === "Enter" || key === "←") {
                keyTile.classList.add("wider-key-tile");
            }
            else {
    ...
    btn.addEventListener("click", (e) => {
        ...
        for (let r = 0; r < maxGuessTime; r++) {
            for (let c = 0; c < answerLength; c++) {
                let tem = document.getElementById(r.toString() + "-" + c.toString());
                if (tem.innerText) {
                    tem.innerText = "";
                    tem.classList.remove("currect", "present", "absent");
                }
            }
        }
        //重置键盘
        for (let i = 0; i < keyboard.length; i++) {
            let currRow = keyboard[i];
            for (let j = 0; j <= currRow.length; j++) {
                if ("A" <= currRow[j] && currRow[j] <= "Z" && currRow[j] !== "Enter") {
                    let temKeytile = document.getElementById("Key" + currRow[j]);
                    temKeytile.classList.remove("currect", "present", "absent");
                }
            }
        }
...
function isValidWord(word) {
    ...
    //判断该单词是否在单词列表中
    else if (word.length === 5 && !wordList.includes(word.toLowerCase())) {
        document.getElementById("result").innerText = "不在单词列表中";
        return false;
    }
    else if (word.length === 5 && wordList.includes(word.toLowerCase())) {
        document.getElementById("result").innerText = "";
...
function handleAnswer(guess) {
    ...
    if (isValidWord(guess)) {
        ...
        let result = calculateColorSequence(guess, answer);
        let n = row - 1;
        let currtile;
        let keyTile;
        for (let c = 0; c < answerLength; c++) {
            currtile = document.getElementById(n.toString() + "-" + c.toString());
            keyTile = document.getElementById("Key" + guess[c].toUpperCase());
            if (result[c] === 'b') {
                currtile.classList.add("currect");
                keyTile.classList.remove("absent", "present");
                keyTile.classList.add("currect");
            }
            else if (result[c] === 'y') {
                currtile.classList.add("present");
                keyTile.classList.remove("absent");
                if (!keyTile.classList.contains("currect")) {
                ...
                if (!keyTile.classList.contains("currect", "present")) {
...
function calculateColorSequence(guess, answer) {
    ...
    for (let i = 0; i < answerLength; i++) {
        if (guess[i] === answer[i]) {
            colorSequence = colorSequence + "b";
        }
        else if (answer.includes(guess[i])) {
            colorSequence = colorSequence + "y";
        }
        else {
            colorSequence = colorSequence + "g";
        }
    }
